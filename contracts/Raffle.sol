...
contract BohdanRaffle is RaffleAccessControl, OwnableUpgradeable {
    ...
    function endRaffle(uint256 randomIndex) public onlyRole(RAFFLE_ADMIN) {
        ...
        //     if (
        //         _participants[i].from >= randomNumber &&
        //         _participants[i].to <= randomNumber
        //     ) {
        ...
        // winner = _participants[randomNumber];
